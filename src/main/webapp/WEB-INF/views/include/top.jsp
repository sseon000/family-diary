		...
		<div class="navbar-collapse">			 
			<ul class="navbar-nav text-uppercase ms-auto">
				...
				<c:if test="${empty loginInfo }">
					<li class="nav-item"><a class="nav-link" href="login.members">LOGIN</a></li>
					<li class="nav-item"><a class="nav-link" href="register.members">JOIN</a></li>
				</c:if>
				<c:if test="${not empty loginInfo}">
